...
- **R-SECRETS-001** SHOULD: Components SHOULD validate the presence and format of required environment variables during initialization and fail fast with clear error messages if critical secrets are missing.
...
# (Exact scanning command derived from project repository)
```
