# Standardize Context-Aware Structured Logging for Error Reporting: Error Logging Operations
...
- **R-LOGGING-001** MUST: All error logging operations MUST use context-aware structured logging that preserves request correlation identifiers.
