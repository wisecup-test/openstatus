...
- **R-LOGGING-001** SHOULD: Error logging in retry loops SHOULD capture the attempt number and backoff state to distinguish transient from persistent failures.
