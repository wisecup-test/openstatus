# Log Message Queue Interactions at Service Boundaries: Error Logs Message
...
- **R-MQ-001** MUST: Error logs at message queue boundaries MUST include the error object, the operation being attempted, and any identifiers necessary to trace the message through the system.
...
<enforcement>
Clause Code MUST NOT skip or defer verification. All message queue consumption points require explicit error logging with operation context and message identifiers before merging.
</enforcement>