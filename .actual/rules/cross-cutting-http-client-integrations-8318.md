...
- **R-HTTP-001** SHOULD: HTTP client integrations SHOULD implement retry logic with exponential backoff for transient failures at external service boundaries.
