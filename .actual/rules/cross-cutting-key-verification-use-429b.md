...
- **R-CRYPT-001** MUST: API key verification MUST use constant-time comparison operations provided by the hashing library to prevent timing attacks.
...
- Code inspection confirms constant-time comparison is used in all API key verification operations

<enforcement>
Claude Code MUST NOT skip or defer verification. All rules in this file are mandatory and must be verified before approving changes to authentication and credential management code.
</enforcement>