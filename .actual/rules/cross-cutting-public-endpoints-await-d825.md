# Validate External Search Parameters Through Dedicated Cache Parser: Public Endpoints Await

These rules are ALWAYS ACTIVE for all public API page endpoints that accept search parameters from external clients as Promise-wrapped objects.

### Rules

- **R-SEARCH-001** MUST: Public API endpoints MUST await the resolution of Promise-wrapped search parameters before passing them to the validation parser.
