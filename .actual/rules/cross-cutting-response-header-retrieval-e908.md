# Standardize Service Boundary Definitions Through Header and Context Accessors: Response Header Retrieval
...
- **R-SBD-001** MUST: Response header retrieval MUST use designated getter methods that accept header key parameters.
...
find . -name 'CONTRIBUTING.md' -o -name 'CODE_REVIEW.md' -o -name '.github/pull_request_template.md'
```
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All boundary accessor patterns must be validated through code review and integration testing before acceptance.
</enforcement>