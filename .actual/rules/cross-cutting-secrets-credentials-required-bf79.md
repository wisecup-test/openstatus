...
- **R-SECRETS-001** MUST: All secrets and credentials required for external service authentication MUST be sourced from environment variables at runtime using the standard library environment access mechanism.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All three acceptance criteria must be confirmed before code is committed.
</enforcement>