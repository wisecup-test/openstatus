...
1. MUST: Authentication credentials for external HTTP clients MUST be retrieved from environment variables and MUST NOT be committed to version control

## Policy Block

- MUST Authentication credentials for external HTTP clients MUST be retrieved from environment variables and MUST NOT be committed to version control
