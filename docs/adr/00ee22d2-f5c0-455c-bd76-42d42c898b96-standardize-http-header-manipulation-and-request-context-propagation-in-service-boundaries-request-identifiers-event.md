...
1. SHOULD: Request identifiers and event tracking data SHOULD be injected into the cache layer early in the request lifecycle for downstream handler access

## Policy Block

- SHOULD Request identifiers and event tracking data SHOULD be injected into the cache layer early in the request lifecycle for downstream handler access
