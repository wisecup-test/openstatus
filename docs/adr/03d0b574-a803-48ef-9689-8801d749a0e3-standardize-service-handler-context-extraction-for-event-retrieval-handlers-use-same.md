...
1. MUST: Handlers MUST use the same context key identifier across all protocol implementations to ensure consistent event retrieval

## Policy Block

- MUST Handlers MUST use the same context key identifier across all protocol implementations to ensure consistent event retrieval
