...
1. MUST: Search parameter validation MUST occur before any asynchronous data prefetching operations that depend on parameter values

## Policy Block

- MUST Search parameter validation MUST occur before any asynchronous data prefetching operations that depend on parameter values
