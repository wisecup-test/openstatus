...
1. SHOULD: Database update operations that persist state changes should be coordinated with message updates to maintain consistency between stored state and user-visible messages.

## Policy Block

- SHOULD Database update operations that persist state changes should be coordinated with message updates to maintain consistency between stored state and user-visible messages.
