...
1. MUST: Generated tokens MUST be encoded in a URL-safe format suitable for HTTP header transmission.

## Policy Block

- MUST Generated tokens MUST be encoded in a URL-safe format suitable for HTTP header transmission.
