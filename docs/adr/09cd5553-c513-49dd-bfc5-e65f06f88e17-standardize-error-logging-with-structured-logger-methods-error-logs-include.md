...
1. SHOULD: Error logs SHOULD include additional structured fields such as operation type, target endpoint, and retry attempt number when available

## Policy Block

- SHOULD Error logs SHOULD include additional structured fields such as operation type, target endpoint, and retry attempt number when available
