...
1. MUST: All HTTP client instances used for external service communication MUST configure an explicit Timeout field at instantiation time

## Policy Block

- MUST All HTTP client instances used for external service communication MUST configure an explicit Timeout field at instantiation time
