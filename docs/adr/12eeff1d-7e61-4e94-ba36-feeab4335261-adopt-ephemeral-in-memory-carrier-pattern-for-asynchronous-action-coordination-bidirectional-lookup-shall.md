...
1. MUST: Bidirectional lookup SHALL be supported between action identifiers and thread identifiers to enable both action-driven and conversation-driven workflows

## Policy Block

- MUST Bidirectional lookup SHALL be supported between action identifiers and thread identifiers to enable both action-driven and conversation-driven workflows
