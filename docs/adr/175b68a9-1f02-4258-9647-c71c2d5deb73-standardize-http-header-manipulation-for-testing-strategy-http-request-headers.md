...
1. MUST: HTTP request headers MUST be set programmatically using the request object's header manipulation interface before client execution

## Policy Block

- MUST HTTP request headers MUST be set programmatically using the request object's header manipulation interface before client execution
