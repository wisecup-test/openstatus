...
1. MUST: The boundary layer MUST expose an interface or factory function that returns HTTP client instances, enabling test doubles to be injected during integration testing.

## Policy Block

- MUST The boundary layer MUST expose an interface or factory function that returns HTTP client instances, enabling test doubles to be injected during integration testing.
