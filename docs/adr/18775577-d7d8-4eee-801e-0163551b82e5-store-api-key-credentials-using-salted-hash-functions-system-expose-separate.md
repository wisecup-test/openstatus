...
1. MAY: The system MAY expose separate public contracts for key generation, hashing, verification, and usage policy to enable modular testing and replacement.

## Policy Block

- MAY The system MAY expose separate public contracts for key generation, hashing, verification, and usage policy to enable modular testing and replacement.
