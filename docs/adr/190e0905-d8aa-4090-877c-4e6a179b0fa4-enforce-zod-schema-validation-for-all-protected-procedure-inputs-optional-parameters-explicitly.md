...
1. MUST: Optional parameters MUST be explicitly marked as optional in the schema rather than relying on runtime undefined checks

## Policy Block

- MUST Optional parameters MUST be explicitly marked as optional in the schema rather than relying on runtime undefined checks
