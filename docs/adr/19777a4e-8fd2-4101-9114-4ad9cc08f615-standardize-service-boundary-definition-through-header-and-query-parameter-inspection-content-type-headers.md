...
1. SHOULD: Content-Type headers SHOULD be inspected before processing request bodies and set explicitly when the content type differs from defaults

## Policy Block

- SHOULD Content-Type headers SHOULD be inspected before processing request bodies and set explicitly when the content type differs from defaults
