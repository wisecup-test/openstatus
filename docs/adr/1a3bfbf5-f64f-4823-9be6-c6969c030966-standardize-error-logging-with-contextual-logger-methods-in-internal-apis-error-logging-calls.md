...
1. MUST: Error logging calls MUST extract error messages using the error interface method that returns string representations

## Policy Block

- MUST Error logging calls MUST extract error messages using the error interface method that returns string representations
