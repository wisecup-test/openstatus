...
1. MUST: HTTP client implementations MUST set explicit User-Agent headers to identify the calling service

## Policy Block

- MUST HTTP client implementations MUST set explicit User-Agent headers to identify the calling service
