...
1. MAY: The implementation MAY expose separate public contracts for key generation, hashing, verification, and usage tracking to support modular testing and reuse.

## Policy Block

- MAY The implementation MAY expose separate public contracts for key generation, hashing, verification, and usage tracking to support modular testing and reuse.
