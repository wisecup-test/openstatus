...
1. MUST: All runtime configuration values that vary by environment MUST be retrieved from environment variables using the standard library environment access functions

## Policy Block

- MUST All runtime configuration values that vary by environment MUST be retrieved from environment variables using the standard library environment access functions
