...
1. MUST: Content-Type headers MUST be validated on inbound requests and set explicitly on outbound requests when transmitting structured data

## Policy Block

- MUST Content-Type headers MUST be validated on inbound requests and set explicitly on outbound requests when transmitting structured data
