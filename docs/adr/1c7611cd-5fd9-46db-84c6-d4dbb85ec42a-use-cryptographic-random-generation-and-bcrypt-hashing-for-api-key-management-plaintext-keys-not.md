...
1. MUST_NOT: Plaintext API keys MUST NOT be stored in any persistent storage system.

## Policy Block

- MUST_NOT Plaintext API keys MUST NOT be stored in any persistent storage system.
