...
1. MAY: Logging implementations MAY include structured fields for request identifiers, event types, and regional information when available from the request context

## Policy Block

- MAY Logging implementations MAY include structured fields for request identifiers, event types, and regional information when available from the request context
