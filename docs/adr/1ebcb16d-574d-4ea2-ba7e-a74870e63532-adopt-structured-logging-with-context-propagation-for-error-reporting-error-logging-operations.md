...
1. MUST: All error logging operations MUST extract context using the context-aware logger retrieval pattern and invoke error-level logging methods with the error object

## Policy Block

- MUST All error logging operations MUST extract context using the context-aware logger retrieval pattern and invoke error-level logging methods with the error object
