...
1. MUST: Validated parameter values MUST be used for conditional logic such as redirects or data fetching decisions

## Policy Block

- MUST Validated parameter values MUST be used for conditional logic such as redirects or data fetching decisions
