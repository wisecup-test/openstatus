...
1. SHOULD: Error logging SHOULD occur at the boundary where errors are first detected or handled

## Policy Block

- SHOULD Error logging SHOULD occur at the boundary where errors are first detected or handled
