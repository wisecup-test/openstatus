...
1. MUST: Error logging MUST occur before error propagation to external error tracking services or error transformation layers

## Policy Block

- MUST Error logging MUST occur before error propagation to external error tracking services or error transformation layers
