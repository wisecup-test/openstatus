...
1. MUST: Security-sensitive values including API keys, service credentials, private keys, and authorization tokens MUST be sourced exclusively from environment variables and MUST NOT be hardcoded in source files

## Policy Block

- MUST Security-sensitive values including API keys, service credentials, private keys, and authorization tokens MUST be sourced exclusively from environment variables and MUST NOT be hardcoded in source files
