...
1. MAY: Additional runtime type guards MAY be applied at service boundaries where data crosses process or network boundaries.

## Policy Block

- MAY Additional runtime type guards MAY be applied at service boundaries where data crosses process or network boundaries.
