...
1. MUST: Public API contracts for key generation, hashing, verification, and usage tracking must be exported as distinct functions with clear separation of concerns

## Policy Block

- MUST Public API contracts for key generation, hashing, verification, and usage tracking must be exported as distinct functions with clear separation of concerns
