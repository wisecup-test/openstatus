...
1. MUST: Error logging at service boundaries MUST use context-aware structured loggers that receive the request context as their first parameter.

## Policy Block

- MUST Error logging at service boundaries MUST use context-aware structured loggers that receive the request context as their first parameter.
