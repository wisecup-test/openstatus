...
1. MUST: Before using any versioned chat platform client library, the consumer must discover the project's dependency lock artifact, resolve the exact installed version, and verify all API methods against that version's official documentation.

## Policy Block

- MUST Before using any versioned chat platform client library, the consumer must discover the project's dependency lock artifact, resolve the exact installed version, and verify all API methods against that version's official documentation.
