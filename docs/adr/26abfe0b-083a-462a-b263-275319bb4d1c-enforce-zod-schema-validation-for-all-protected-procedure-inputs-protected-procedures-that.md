...
1. MUST: All protected procedures that accept input parameters MUST declare a schema using the validation library detected in the project dependencies before executing any business logic or database queries

## Policy Block

- MUST All protected procedures that accept input parameters MUST declare a schema using the validation library detected in the project dependencies before executing any business logic or database queries
