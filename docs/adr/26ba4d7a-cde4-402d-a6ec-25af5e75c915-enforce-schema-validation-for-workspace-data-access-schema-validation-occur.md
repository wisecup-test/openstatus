...
1. MUST: Schema validation MUST occur immediately after data retrieval and before any transformation, caching, or propagation to downstream systems.

## Policy Block

- MUST Schema validation MUST occur immediately after data retrieval and before any transformation, caching, or propagation to downstream systems.
