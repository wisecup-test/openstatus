...
1. SHOULD: Query procedures SHOULD log errors at the service boundary layer before transforming errors for API consumers

## Policy Block

- SHOULD Query procedures SHOULD log errors at the service boundary layer before transforming errors for API consumers
