...
1. MAY: Contract types MAY include protocol buffer message interfaces for cross-service communication

## Policy Block

- MAY Contract types MAY include protocol buffer message interfaces for cross-service communication
