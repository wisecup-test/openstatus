...
1. MUST: Content-Type headers MUST be validated on incoming requests and explicitly set on outgoing requests when body content is present

## Policy Block

- MUST Content-Type headers MUST be validated on incoming requests and explicitly set on outgoing requests when body content is present
