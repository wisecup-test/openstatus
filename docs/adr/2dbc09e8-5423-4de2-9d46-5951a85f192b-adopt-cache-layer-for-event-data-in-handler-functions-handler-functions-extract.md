# Adopt Cache Layer for Event Data in Handler Functions: Handler Functions Extract
...
1. SHOULD: Handler functions SHOULD extract query parameters using Query operations to populate cache entries with request-specific data

## Policy Block

- SHOULD Handler functions SHOULD extract query parameters using Query operations to populate cache entries with request-specific data
