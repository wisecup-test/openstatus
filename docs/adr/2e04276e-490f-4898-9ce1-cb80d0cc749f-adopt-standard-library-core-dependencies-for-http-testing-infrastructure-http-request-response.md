...
1. MUST: All HTTP request and response processing in integration test paths must use standard library packages for encoding, context propagation, and network operations

## Policy Block

- MUST All HTTP request and response processing in integration test paths must use standard library packages for encoding, context propagation, and network operations
