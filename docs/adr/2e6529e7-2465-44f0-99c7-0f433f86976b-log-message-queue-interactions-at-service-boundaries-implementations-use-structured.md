...
1. MAY: Implementations MAY use structured logging formats to capture message metadata, timestamps, and correlation identifiers as separate fields rather than concatenated strings.

## Policy Block

- MAY Implementations MAY use structured logging formats to capture message metadata, timestamps, and correlation identifiers as separate fields rather than concatenated strings.
