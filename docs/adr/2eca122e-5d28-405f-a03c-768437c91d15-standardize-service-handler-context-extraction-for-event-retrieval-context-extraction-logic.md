...
1. SHOULD: Context extraction logic SHOULD be isolated from retry and resilience mechanisms to maintain separation of concerns

## Policy Block

- SHOULD Context extraction logic SHOULD be isolated from retry and resilience mechanisms to maintain separation of concerns
