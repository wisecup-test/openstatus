...
1. MUST: Page components that accept search parameters MUST await the resolution of the search parameters promise before passing it to the validation cache

## Policy Block

- MUST Page components that accept search parameters MUST await the resolution of the search parameters promise before passing it to the validation cache
