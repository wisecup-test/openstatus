...
1. MUST: Each external service client MUST document the required environment variable names in its initialization or constructor code

## Policy Block

- MUST Each external service client MUST document the required environment variable names in its initialization or constructor code
