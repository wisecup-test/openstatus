...
1. MAY: Application-layer caching using in-process data structures may supplement persistent cache layers for read-heavy access patterns within a single request lifecycle

## Policy Block

- MAY Application-layer caching using in-process data structures may supplement persistent cache layers for read-heavy access patterns within a single request lifecycle
