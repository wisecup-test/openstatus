...
1. MUST: Tool renderer methods MUST accept unknown input types and perform runtime type narrowing to handle tool-specific data structures.

## Policy Block

- MUST Tool renderer methods MUST accept unknown input types and perform runtime type narrowing to handle tool-specific data structures.
