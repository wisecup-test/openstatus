...
1. MUST: Enum-based parameters MUST use schema enum validation to restrict values to the declared set of allowed constants

## Policy Block

- MUST Enum-based parameters MUST use schema enum validation to restrict values to the declared set of allowed constants
