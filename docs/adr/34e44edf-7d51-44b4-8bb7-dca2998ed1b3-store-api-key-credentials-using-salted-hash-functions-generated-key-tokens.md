...
1. MUST: Generated API key tokens MUST derive from cryptographically secure random bytes with minimum entropy of 128 bits.

## Policy Block

- MUST Generated API key tokens MUST derive from cryptographically secure random bytes with minimum entropy of 128 bits.
