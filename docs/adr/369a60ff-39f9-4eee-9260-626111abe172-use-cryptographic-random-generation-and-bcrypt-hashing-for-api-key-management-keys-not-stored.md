...
1. MUST: API keys MUST NOT be stored in plaintext; only cryptographic hashes of keys MUST be persisted

## Policy Block

- MUST API keys MUST NOT be stored in plaintext; only cryptographic hashes of keys MUST be persisted
