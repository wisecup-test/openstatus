...
1. MUST: The search parameter cache parser MUST be invoked on the Promise-wrapped searchParams object before extracting individual parameter values

## Policy Block

- MUST The search parameter cache parser MUST be invoked on the Promise-wrapped searchParams object before extracting individual parameter values
