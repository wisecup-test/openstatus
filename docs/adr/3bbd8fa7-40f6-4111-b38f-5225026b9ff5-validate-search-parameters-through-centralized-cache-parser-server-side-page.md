...
1. MUST: Server-side page components MUST parse search parameters through a centralized cache parser before using parameter values in application logic

## Policy Block

- MUST Server-side page components MUST parse search parameters through a centralized cache parser before using parameter values in application logic
