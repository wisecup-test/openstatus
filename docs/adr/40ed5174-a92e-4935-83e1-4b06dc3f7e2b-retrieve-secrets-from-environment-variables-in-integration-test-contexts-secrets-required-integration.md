...
1. MUST: All secrets required for integration test execution SHALL be retrieved from environment variables using the standard library environment access function

## Policy Block

- MUST All secrets required for integration test execution SHALL be retrieved from environment variables using the standard library environment access function
