...
1. MUST: HTTP client implementations shall set User-Agent headers to identify the service making requests

## Policy Block

- MUST HTTP client implementations shall set User-Agent headers to identify the service making requests
