...
1. MUST_NOT: Plaintext API key tokens must not be persisted in any storage system after initial generation and presentation to the user

## Policy Block

- MUST_NOT Plaintext API key tokens must not be persisted in any storage system after initial generation and presentation to the user
