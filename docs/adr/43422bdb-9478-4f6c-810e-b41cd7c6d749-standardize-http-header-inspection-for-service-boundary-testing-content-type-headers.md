...
1. MUST: Content-Type headers MUST be validated when request bodies are present, and MUST be set explicitly when sending JSON payloads

## Policy Block

- MUST Content-Type headers MUST be validated when request bodies are present, and MUST be set explicitly when sending JSON payloads
