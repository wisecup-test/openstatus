...
1. MAY: Test fixtures MAY provide default or mock values for environment variables in non-production test scenarios

## Policy Block

- MAY Test fixtures MAY provide default or mock values for environment variables in non-production test scenarios
