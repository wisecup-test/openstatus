...
1. SHOULD: Handler implementations SHOULD expose IsSuccessful methods on response contracts to encapsulate success criteria

## Policy Block

- SHOULD Handler implementations SHOULD expose IsSuccessful methods on response contracts to encapsulate success criteria
