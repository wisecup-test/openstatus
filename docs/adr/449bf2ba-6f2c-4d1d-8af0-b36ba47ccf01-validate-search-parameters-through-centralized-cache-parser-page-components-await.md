...
1. MUST: Page components MUST await the resolution of the search parameters Promise before accessing parameter values

## Policy Block

- MUST Page components MUST await the resolution of the search parameters Promise before accessing parameter values
