...
1. MUST: Page components that conditionally redirect based on search parameter presence MUST parse parameters before evaluating redirect conditions

## Policy Block

- MUST Page components that conditionally redirect based on search parameter presence MUST parse parameters before evaluating redirect conditions
