...
1. SHOULD: Tool renderers SHOULD transform tool outputs into normalized change row representations for consistent table-based visualization.

## Policy Block

- SHOULD Tool renderers SHOULD transform tool outputs into normalized change row representations for consistent table-based visualization.
