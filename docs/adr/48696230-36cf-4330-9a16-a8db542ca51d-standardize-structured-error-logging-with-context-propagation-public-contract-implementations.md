...
1. SHOULD: Public API contract implementations that return error responses SHOULD log the error with sufficient context to correlate the log entry with the response body

## Policy Block

- SHOULD Public API contract implementations that return error responses SHOULD log the error with sufficient context to correlate the log entry with the response body
