...
1. MAY: Retry count parameters may be sourced from request query parameters, cached event data, or monitor configuration specifications.

## Policy Block

- MAY Retry count parameters may be sourced from request query parameters, cached event data, or monitor configuration specifications.
