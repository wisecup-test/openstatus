...
1. MUST: All authentication secrets required for integration tests and external service clients MUST be retrieved from environment variables at runtime using the standard library environment access functions

## Policy Block

- MUST All authentication secrets required for integration tests and external service clients MUST be retrieved from environment variables at runtime using the standard library environment access functions
