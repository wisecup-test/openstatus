...
1. SHOULD: Response bodies from external HTTP calls SHOULD be properly closed to prevent resource leaks

## Policy Block

- SHOULD Response bodies from external HTTP calls SHOULD be properly closed to prevent resource leaks
