...
1. MUST: All tool renderer implementations MUST conform to a standardized interface contract that defines both draft rendering and result rendering methods.

## Policy Block

- MUST All tool renderer implementations MUST conform to a standardized interface contract that defines both draft rendering and result rendering methods.
