...
1. SHOULD: External client requests SHOULD set identifying headers to distinguish service-originated traffic from other sources.

## Policy Block

- SHOULD External client requests SHOULD set identifying headers to distinguish service-originated traffic from other sources.
