...
1. MAY: Error logs MAY include additional structured fields such as region, provider, monitor type, or assertion results when relevant to the operational context

## Policy Block

- MAY Error logs MAY include additional structured fields such as region, provider, monitor type, or assertion results when relevant to the operational context
