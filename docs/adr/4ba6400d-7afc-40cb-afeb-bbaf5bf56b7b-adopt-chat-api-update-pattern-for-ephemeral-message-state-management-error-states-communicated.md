...
1. MUST: Error states must be communicated through message updates with descriptive text content rather than throwing exceptions that leave messages in stale states.

## Policy Block

- MUST Error states must be communicated through message updates with descriptive text content rather than throwing exceptions that leave messages in stale states.
