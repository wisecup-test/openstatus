...
1. MUST: API key generation MUST use cryptographically secure random number generation with sufficient entropy to prevent prediction or enumeration attacks

## Policy Block

- MUST API key generation MUST use cryptographically secure random number generation with sufficient entropy to prevent prediction or enumeration attacks
