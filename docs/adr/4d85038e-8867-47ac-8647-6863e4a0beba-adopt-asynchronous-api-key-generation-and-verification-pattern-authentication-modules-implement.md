...
1. MAY: Authentication modules may implement credential refresh policies that determine when stored hashes should be updated based on last usage timestamps

## Policy Block

- MAY Authentication modules may implement credential refresh policies that determine when stored hashes should be updated based on last usage timestamps
