...
1. MUST_NOT: Secrets and credentials MUST NOT be hardcoded in source files, configuration files committed to version control, or embedded in compiled binaries

## Policy Block

- MUST_NOT Secrets and credentials MUST NOT be hardcoded in source files, configuration files committed to version control, or embedded in compiled binaries
