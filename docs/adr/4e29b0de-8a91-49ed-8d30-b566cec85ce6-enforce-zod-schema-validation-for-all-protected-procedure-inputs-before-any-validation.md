...
1. MUST: Before using any validation library API, the consumer MUST locate the project's dependency lock artifact, resolve the exact installed version, and verify all schema methods against that version's official documentation

## Policy Block

- MUST Before using any validation library API, the consumer MUST locate the project's dependency lock artifact, resolve the exact installed version, and verify all schema methods against that version's official documentation
