...
1. MUST: API key tokens MUST be hashed using a salted cryptographic hash function with a work factor of at least 10 rounds before storage.

## Policy Block

- MUST API key tokens MUST be hashed using a salted cryptographic hash function with a work factor of at least 10 rounds before storage.
