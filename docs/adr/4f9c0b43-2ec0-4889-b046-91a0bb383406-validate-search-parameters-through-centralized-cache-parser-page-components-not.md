...
1. MUST_NOT: Page components MUST NOT access raw search parameter values directly without validation through the cache parser

## Policy Block

- MUST_NOT Page components MUST NOT access raw search parameter values directly without validation through the cache parser
