...
1. MUST: HTTP client boundaries MUST implement structured error logging with context propagation for observability

## Policy Block

- MUST HTTP client boundaries MUST implement structured error logging with context propagation for observability
