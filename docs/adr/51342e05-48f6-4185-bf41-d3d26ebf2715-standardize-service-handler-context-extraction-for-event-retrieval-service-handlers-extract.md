...
1. MUST: All service handlers MUST extract event context using the context accessor method provided by the HTTP framework's context object

## Policy Block

- MUST All service handlers MUST extract event context using the context accessor method provided by the HTTP framework's context object
