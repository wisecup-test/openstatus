...
1. MUST: HTTP client interactions with external services MUST set identifying headers to enable request tracing across system boundaries

## Policy Block

- MUST HTTP client interactions with external services MUST set identifying headers to enable request tracing across system boundaries
