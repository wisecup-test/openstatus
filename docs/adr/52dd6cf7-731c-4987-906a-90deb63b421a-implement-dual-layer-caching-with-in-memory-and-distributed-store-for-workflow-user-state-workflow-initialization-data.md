...
1. SHOULD: Workflow initialization data SHOULD be persisted to distributed cache before launching asynchronous workflow steps to ensure state availability across process boundaries

## Policy Block

- SHOULD Workflow initialization data SHOULD be persisted to distributed cache before launching asynchronous workflow steps to ensure state availability across process boundaries
