...
1. MUST: Error logging calls MUST include the error object using the logging library's error attachment method rather than string formatting

## Policy Block

- MUST Error logging calls MUST include the error object using the logging library's error attachment method rather than string formatting
