...
1. MAY: Implementations MAY integrate with cloud task queue services for asynchronous workflow execution

## Policy Block

- MAY Implementations MAY integrate with cloud task queue services for asynchronous workflow execution
