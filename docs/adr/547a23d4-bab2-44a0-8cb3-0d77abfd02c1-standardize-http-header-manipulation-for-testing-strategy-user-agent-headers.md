...
1. MUST: User-Agent headers MUST be set to identify the checking service to external endpoints

## Policy Block

- MUST User-Agent headers MUST be set to identify the checking service to external endpoints
