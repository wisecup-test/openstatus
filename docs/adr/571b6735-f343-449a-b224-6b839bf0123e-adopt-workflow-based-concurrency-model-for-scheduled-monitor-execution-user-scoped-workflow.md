...
1. MUST: User-scoped workflow data MUST be validated against schema definitions before workflow execution

## Policy Block

- MUST User-scoped workflow data MUST be validated against schema definitions before workflow execution
