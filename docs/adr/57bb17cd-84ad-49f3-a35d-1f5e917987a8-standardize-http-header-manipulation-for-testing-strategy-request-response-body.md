...
1. MUST: Request and response body content MUST be accessible for assertion evaluation and validation logic

## Policy Block

- MUST Request and response body content MUST be accessible for assertion evaluation and validation logic
