...
1. MUST: All HTTP response body access in integration test contexts shall use the Body field of the response structure

## Policy Block

- MUST All HTTP response body access in integration test contexts shall use the Body field of the response structure
