...
1. MUST: Public API contracts for assertion evaluation MUST separate number-based and string-based comparators into distinct functions

## Policy Block

- MUST Public API contracts for assertion evaluation MUST separate number-based and string-based comparators into distinct functions
