...
1. SHOULD: The registry SHOULD provide optional rendering methods that return undefined when a tool does not support a particular rendering phase.

## Policy Block

- SHOULD The registry SHOULD provide optional rendering methods that return undefined when a tool does not support a particular rendering phase.
