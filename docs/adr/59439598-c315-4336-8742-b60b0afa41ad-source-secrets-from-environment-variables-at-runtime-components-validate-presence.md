# Source Secrets from Environment Variables at Runtime: Components Validate Presence
...
1. SHOULD: Components SHOULD validate the presence and format of required environment variables during initialization and fail fast with clear error messages if critical secrets are missing

## Policy Block

- SHOULD Components SHOULD validate the presence and format of required environment variables during initialization and fail fast with clear error messages if critical secrets are missing
