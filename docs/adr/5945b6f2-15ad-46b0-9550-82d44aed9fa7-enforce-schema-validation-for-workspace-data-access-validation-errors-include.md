...
1. SHOULD: Validation errors SHOULD include sufficient context to identify the source query, affected entity type, and specific validation failure reason for debugging.

## Policy Block

- SHOULD Validation errors SHOULD include sufficient context to identify the source query, affected entity type, and specific validation failure reason for debugging.
