...
1. MUST: The carrier interface SHALL provide atomic consume operations that retrieve and delete action state in a single operation to prevent duplicate execution

## Policy Block

- MUST The carrier interface SHALL provide atomic consume operations that retrieve and delete action state in a single operation to prevent duplicate execution
