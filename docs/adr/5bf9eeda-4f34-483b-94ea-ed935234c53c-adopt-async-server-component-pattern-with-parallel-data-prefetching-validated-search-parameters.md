...
1. SHOULD: Validated search parameters SHOULD be used to conditionally prefetch only the data required for the current request context

## Policy Block

- SHOULD Validated search parameters SHOULD be used to conditionally prefetch only the data required for the current request context
