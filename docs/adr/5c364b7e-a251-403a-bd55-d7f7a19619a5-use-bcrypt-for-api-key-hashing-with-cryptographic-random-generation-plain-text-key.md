...
1. MUST_NOT: Plain-text API key tokens MUST_NOT be persisted in any storage system after initial generation

## Policy Block

- MUST_NOT Plain-text API key tokens MUST_NOT be persisted in any storage system after initial generation
