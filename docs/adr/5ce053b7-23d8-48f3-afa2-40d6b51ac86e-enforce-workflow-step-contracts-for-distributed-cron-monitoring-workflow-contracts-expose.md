...
1. MAY: Workflow contracts MAY expose internal cache layer operations as part of the public contract when cache consistency is critical to step transition reliability.

## Policy Block

- MAY Workflow contracts MAY expose internal cache layer operations as part of the public contract when cache consistency is critical to step transition reliability.
