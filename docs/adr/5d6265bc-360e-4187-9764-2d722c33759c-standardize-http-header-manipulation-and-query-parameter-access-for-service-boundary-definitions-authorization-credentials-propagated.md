...
1. MUST: Authorization credentials MUST be propagated via request headers using bearer token format when authenticating to external services

## Policy Block

- MUST Authorization credentials MUST be propagated via request headers using bearer token format when authenticating to external services
