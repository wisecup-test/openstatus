...
1. MUST: HTTP client operations that fail MUST log errors through the context-bound logger instance

## Policy Block

- MUST HTTP client operations that fail MUST log errors through the context-bound logger instance
