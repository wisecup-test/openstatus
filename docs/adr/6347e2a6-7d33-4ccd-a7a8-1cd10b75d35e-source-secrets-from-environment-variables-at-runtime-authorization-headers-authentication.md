...
1. SHOULD: Authorization headers and authentication tokens constructed from environment-sourced secrets SHOULD be set immediately before use and SHOULD NOT be stored in long-lived data structures

## Policy Block

- SHOULD Authorization headers and authentication tokens constructed from environment-sourced secrets SHOULD be set immediately before use and SHOULD NOT be stored in long-lived data structures
