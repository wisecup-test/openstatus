...
1. MUST: HTTP client operations that interact with external services MUST log errors with sufficient context to identify the request, response metadata, and timing information

## Policy Block

- MUST HTTP client operations that interact with external services MUST log errors with sufficient context to identify the request, response metadata, and timing information
