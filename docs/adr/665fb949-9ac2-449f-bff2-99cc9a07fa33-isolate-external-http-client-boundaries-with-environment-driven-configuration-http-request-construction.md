...
1. MUST: HTTP request construction MUST include query parameter encoding and header configuration before client execution

## Policy Block

- MUST HTTP request construction MUST include query parameter encoding and header configuration before client execution
