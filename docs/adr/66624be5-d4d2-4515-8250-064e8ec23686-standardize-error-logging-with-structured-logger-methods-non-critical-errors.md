...
1. MAY: Non-critical errors in assertion evaluation or response parsing MAY be logged at warning level instead of error level

## Policy Block

- MAY Non-critical errors in assertion evaluation or response parsing MAY be logged at warning level instead of error level
