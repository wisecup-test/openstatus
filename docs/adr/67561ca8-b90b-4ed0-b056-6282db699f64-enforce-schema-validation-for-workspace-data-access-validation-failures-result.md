...
1. MUST: Validation failures MUST result in explicit error handling that prevents invalid data from entering workflow state machines, cache layers, or task queues.

## Policy Block

- MUST Validation failures MUST result in explicit error handling that prevents invalid data from entering workflow state machines, cache layers, or task queues.
