...
1. MUST: Context-aware logging MUST retrieve the logger instance from the request context to preserve correlation identifiers and request metadata

## Policy Block

- MUST Context-aware logging MUST retrieve the logger instance from the request context to preserve correlation identifiers and request metadata
