...
1. MUST: HTTP client instances used to communicate with external endpoints MUST be constructed in a dedicated boundary layer separate from handler and job execution logic.

## Policy Block

- MUST HTTP client instances used to communicate with external endpoints MUST be constructed in a dedicated boundary layer separate from handler and job execution logic.
