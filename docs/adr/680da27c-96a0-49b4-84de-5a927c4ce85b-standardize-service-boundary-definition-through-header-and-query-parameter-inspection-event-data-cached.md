...
1. MUST: Event data cached in the request context MUST be set with consistent key names across all handler types

## Policy Block

- MUST Event data cached in the request context MUST be set with consistent key names across all handler types
