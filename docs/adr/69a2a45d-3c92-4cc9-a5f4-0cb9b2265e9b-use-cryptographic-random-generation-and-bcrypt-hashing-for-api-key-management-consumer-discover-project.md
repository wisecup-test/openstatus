...
1. MUST: The consumer MUST discover the project's dependency lock file and resolve the exact installed versions of cryptographic and hashing libraries before implementation.

## Policy Block

- MUST The consumer MUST discover the project's dependency lock file and resolve the exact installed versions of cryptographic and hashing libraries before implementation.
