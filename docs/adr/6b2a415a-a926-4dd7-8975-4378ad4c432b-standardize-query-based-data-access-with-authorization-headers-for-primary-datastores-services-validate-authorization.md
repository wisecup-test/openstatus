...
1. MUST: Services MUST validate authorization credentials via middleware before processing requests that access primary datastores.

## Policy Block

- MUST Services MUST validate authorization credentials via middleware before processing requests that access primary datastores.
