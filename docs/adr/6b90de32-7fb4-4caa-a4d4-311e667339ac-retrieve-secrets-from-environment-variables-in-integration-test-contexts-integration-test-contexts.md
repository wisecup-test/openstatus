...
1. MAY: Integration test contexts MAY log the presence or absence of required environment variables for debugging purposes but SHALL NOT log the secret values themselves

## Policy Block

- MAY Integration test contexts MAY log the presence or absence of required environment variables for debugging purposes but SHALL NOT log the secret values themselves
