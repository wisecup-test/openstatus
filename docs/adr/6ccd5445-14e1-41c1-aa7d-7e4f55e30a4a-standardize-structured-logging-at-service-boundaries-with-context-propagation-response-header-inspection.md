...
1. SHOULD: Response header inspection SHOULD be logged when content negotiation or protocol-specific metadata affects request processing

## Policy Block

- SHOULD Response header inspection SHOULD be logged when content negotiation or protocol-specific metadata affects request processing
