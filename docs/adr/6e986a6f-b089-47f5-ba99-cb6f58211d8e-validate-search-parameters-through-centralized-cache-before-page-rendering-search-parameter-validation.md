...
1. MUST: Search parameter validation MUST occur before initiating any query prefetch operations or conditional redirects

## Policy Block

- MUST Search parameter validation MUST occur before initiating any query prefetch operations or conditional redirects
