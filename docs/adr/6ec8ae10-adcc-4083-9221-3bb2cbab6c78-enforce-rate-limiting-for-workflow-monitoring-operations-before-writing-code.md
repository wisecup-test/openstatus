...
1. MUST: Before writing code that instantiates rate limiting components from versioned libraries, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation.

## Policy Block

- MUST Before writing code that instantiates rate limiting components from versioned libraries, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation.
