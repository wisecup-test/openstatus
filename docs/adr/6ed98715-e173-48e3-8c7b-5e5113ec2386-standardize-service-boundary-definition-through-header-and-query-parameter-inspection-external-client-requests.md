...
1. MUST: External client requests MUST set User-Agent headers to identify the service origin

## Policy Block

- MUST External client requests MUST set User-Agent headers to identify the service origin
