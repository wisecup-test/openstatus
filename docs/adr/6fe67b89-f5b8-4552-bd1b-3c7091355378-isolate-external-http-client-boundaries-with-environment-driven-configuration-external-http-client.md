...
1. MUST: External HTTP client instances MUST be configured using environment variables for endpoint URLs and authentication credentials

## Policy Block

- MUST External HTTP client instances MUST be configured using environment variables for endpoint URLs and authentication credentials
