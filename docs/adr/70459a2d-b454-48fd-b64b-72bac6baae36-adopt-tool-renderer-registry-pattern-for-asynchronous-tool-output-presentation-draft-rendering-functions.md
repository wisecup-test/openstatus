...
1. MUST: Draft rendering functions MUST accept tool input and return a structured change representation or undefined

## Policy Block

- MUST Draft rendering functions MUST accept tool input and return a structured change representation or undefined
