...
1. SHOULD: HTTP clients SHOULD accept context parameters to enable request cancellation and distributed tracing

## Policy Block

- SHOULD HTTP clients SHOULD accept context parameters to enable request cancellation and distributed tracing
