...
1. SHOULD: HTTP clients SHOULD use structured logging with context to record configuration errors and request failures

## Policy Block

- SHOULD HTTP clients SHOULD use structured logging with context to record configuration errors and request failures
