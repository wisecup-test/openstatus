...
1. MAY: Handlers MAY extract query parameters through the cache-layer interface when protocol-agnostic access patterns are beneficial

## Policy Block

- MAY Handlers MAY extract query parameters through the cache-layer interface when protocol-agnostic access patterns are beneficial
