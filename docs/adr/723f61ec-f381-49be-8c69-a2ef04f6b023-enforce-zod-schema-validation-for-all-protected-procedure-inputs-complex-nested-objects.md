...
1. SHOULD: Complex nested objects SHOULD decompose validation into reusable schema fragments that can be composed across multiple procedures

## Policy Block

- SHOULD Complex nested objects SHOULD decompose validation into reusable schema fragments that can be composed across multiple procedures
