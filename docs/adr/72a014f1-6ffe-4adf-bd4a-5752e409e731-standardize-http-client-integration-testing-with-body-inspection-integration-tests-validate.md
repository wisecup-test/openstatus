...
1. SHOULD: Integration tests SHOULD validate both successful response bodies and error response bodies to ensure complete contract coverage

## Policy Block

- SHOULD Integration tests SHOULD validate both successful response bodies and error response bodies to ensure complete contract coverage
