...
1. MUST: Request context metadata MUST be propagated through framework context storage mechanisms when crossing handler boundaries

## Policy Block

- MUST Request context metadata MUST be propagated through framework context storage mechanisms when crossing handler boundaries
