...
1. SHOULD: Message updates should use semantic prefixes or emoji indicators to visually distinguish state types such as errors, cancellations, and expirations.

## Policy Block

- SHOULD Message updates should use semantic prefixes or emoji indicators to visually distinguish state types such as errors, cancellations, and expirations.
