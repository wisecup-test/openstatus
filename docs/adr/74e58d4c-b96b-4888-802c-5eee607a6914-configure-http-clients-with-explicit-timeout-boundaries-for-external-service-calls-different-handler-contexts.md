...
1. MAY: Different handler contexts MAY configure different timeout thresholds based on expected service response characteristics

## Policy Block

- MAY Different handler contexts MAY configure different timeout thresholds based on expected service response characteristics
