# Adopt Async Server Component Pattern with Parallel Data Prefetching: Server Page Components
...
1. MUST: Server page components that accept search parameters MUST declare the searchParams prop with a Promise type signature and await its resolution before accessing parameter values

## Policy Block

- MUST Server page components that accept search parameters MUST declare the searchParams prop with a Promise type signature and await its resolution before accessing parameter values
