...
1. MAY: Response body validation may be deferred until after retry logic completes successfully

## Policy Block

- MAY Response body validation may be deferred until after retry logic completes successfully
