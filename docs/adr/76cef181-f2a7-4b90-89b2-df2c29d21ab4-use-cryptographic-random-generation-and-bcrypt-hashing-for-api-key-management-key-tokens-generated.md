...
1. MUST: API key tokens MUST be generated using cryptographically secure random byte generation with minimum 128-bit entropy.

## Policy Block

- MUST API key tokens MUST be generated using cryptographically secure random byte generation with minimum 128-bit entropy.
