...
1. MUST: Search parameter parsing MUST occur before any data fetching operations that depend on parameter values

## Policy Block

- MUST Search parameter parsing MUST occur before any data fetching operations that depend on parameter values
