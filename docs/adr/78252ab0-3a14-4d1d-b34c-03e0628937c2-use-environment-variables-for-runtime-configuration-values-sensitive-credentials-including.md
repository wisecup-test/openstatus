...
1. MUST: Sensitive credentials including API keys, authentication tokens, and service account keys MUST be sourced from environment variables and MUST NOT be embedded in source code or version control.

## Policy Block

- MUST Sensitive credentials including API keys, authentication tokens, and service account keys MUST be sourced from environment variables and MUST NOT be embedded in source code or version control.
