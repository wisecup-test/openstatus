...
1. MAY: Services MAY enrich log entries with additional context-specific metadata such as task identifiers or user identifiers when available

## Policy Block

- MAY Services MAY enrich log entries with additional context-specific metadata such as task identifiers or user identifiers when available
