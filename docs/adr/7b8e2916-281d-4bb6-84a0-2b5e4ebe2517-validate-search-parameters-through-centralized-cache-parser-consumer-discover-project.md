...
1. MUST: The consumer MUST discover the project's dependency lock file and resolve the exact installed version of the search parameter validation library before implementing validation logic

## Policy Block

- MUST The consumer MUST discover the project's dependency lock file and resolve the exact installed version of the search parameter validation library before implementing validation logic
