...
1. SHOULD: State stores should provide separate namespaces for action state and thread-to-action mappings to support concurrent interactions within the same conversation thread

## Policy Block

- SHOULD State stores should provide separate namespaces for action state and thread-to-action mappings to support concurrent interactions within the same conversation thread
