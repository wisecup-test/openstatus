...
1. MAY: Health check endpoints MAY include region and provider metadata in responses to support distributed system topology visibility

## Policy Block

- MAY Health check endpoints MAY include region and provider metadata in responses to support distributed system topology visibility
