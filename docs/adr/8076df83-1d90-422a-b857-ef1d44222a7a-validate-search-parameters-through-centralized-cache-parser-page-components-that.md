...
1. MUST: All page components that receive search parameters MUST parse them through the centralized cache parser before consuming any parameter values

## Policy Block

- MUST All page components that receive search parameters MUST parse them through the centralized cache parser before consuming any parameter values
