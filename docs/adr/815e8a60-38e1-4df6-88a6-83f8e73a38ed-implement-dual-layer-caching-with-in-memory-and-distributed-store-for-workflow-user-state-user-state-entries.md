...
1. MUST: User state entries in distributed cache SHALL be configured with expiration policies matching the maximum workflow duration plus a safety margin

## Policy Block

- MUST User state entries in distributed cache SHALL be configured with expiration policies matching the maximum workflow duration plus a safety margin
