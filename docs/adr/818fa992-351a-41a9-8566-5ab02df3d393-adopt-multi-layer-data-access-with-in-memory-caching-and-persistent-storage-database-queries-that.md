...
1. MUST: Database queries that retrieve user or workspace entities must apply schema validation to all result sets before propagating data to application logic

## Policy Block

- MUST Database queries that retrieve user or workspace entities must apply schema validation to all result sets before propagating data to application logic
