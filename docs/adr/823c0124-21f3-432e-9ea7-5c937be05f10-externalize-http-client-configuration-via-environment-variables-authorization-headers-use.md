...
1. SHOULD: Authorization headers SHOULD use bearer token format when transmitting API keys to external services

## Policy Block

- SHOULD Authorization headers SHOULD use bearer token format when transmitting API keys to external services
