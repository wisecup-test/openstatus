# Standardize Structured Logging with zerolog for Observability: Logger Instances Obtained
...
1. MUST: Logger instances MUST be obtained from the request context to preserve request-scoped fields and trace identifiers

## Policy Block

- MUST Logger instances MUST be obtained from the request context to preserve request-scoped fields and trace identifiers
