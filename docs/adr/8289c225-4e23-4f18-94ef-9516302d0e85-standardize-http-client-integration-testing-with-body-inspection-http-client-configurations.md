...
1. MUST: HTTP client configurations MUST specify explicit timeout values to prevent unbounded blocking at service boundaries

## Policy Block

- MUST HTTP client configurations MUST specify explicit timeout values to prevent unbounded blocking at service boundaries
