...
1. SHOULD: HTTP client integrations SHOULD implement retry logic with exponential backoff for transient failures at external service boundaries

## Policy Block

- SHOULD HTTP client integrations SHOULD implement retry logic with exponential backoff for transient failures at external service boundaries
