# Standardize Query-Based Data Access with Authorization Headers for Primary Datastores: Datastore Client Requests
...
1. MUST: All datastore client requests MUST include authorization headers with bearer token credentials retrieved from runtime configuration sources.

## Policy Block

- MUST All datastore client requests MUST include authorization headers with bearer token credentials retrieved from runtime configuration sources.
