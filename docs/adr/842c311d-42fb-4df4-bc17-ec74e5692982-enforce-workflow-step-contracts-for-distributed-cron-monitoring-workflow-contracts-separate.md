...
1. SHOULD: Workflow contracts SHOULD separate concerns between user-scoped state retrieval, workspace validation, and task queue submission to enable independent evolution of each coordination boundary.

## Policy Block

- SHOULD Workflow contracts SHOULD separate concerns between user-scoped state retrieval, workspace validation, and task queue submission to enable independent evolution of each coordination boundary.
