...
1. MUST: The registry lookup function MUST accept a tool name string and return the corresponding renderer or undefined if no renderer is registered

## Policy Block

- MUST The registry lookup function MUST accept a tool name string and return the corresponding renderer or undefined if no renderer is registered
