...
1. MUST: All service boundary handlers MUST retrieve request-scoped event context using the framework's context retrieval mechanism before processing external requests.

## Policy Block

- MUST All service boundary handlers MUST retrieve request-scoped event context using the framework's context retrieval mechanism before processing external requests.
