...
1. SHOULD: Custom header propagation SHOULD iterate over header collections and apply values using the same accessor pattern

## Policy Block

- SHOULD Custom header propagation SHOULD iterate over header collections and apply values using the same accessor pattern
