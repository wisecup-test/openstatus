...
1. SHOULD: Integration tests SHOULD verify Content-Type header handling for both request construction and response parsing

## Policy Block

- SHOULD Integration tests SHOULD verify Content-Type header handling for both request construction and response parsing
