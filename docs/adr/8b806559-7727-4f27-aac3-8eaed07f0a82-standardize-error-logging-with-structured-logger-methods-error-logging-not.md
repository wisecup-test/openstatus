...
1. MUST_NOT: Error logging MUST NOT block the error handling flow or suppress error propagation to callers

## Policy Block

- MUST_NOT Error logging MUST NOT block the error handling flow or suppress error propagation to callers
