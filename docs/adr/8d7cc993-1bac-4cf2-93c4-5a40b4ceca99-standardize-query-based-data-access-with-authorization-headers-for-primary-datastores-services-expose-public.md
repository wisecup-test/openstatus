...
1. MAY: Services MAY expose public API contracts that abstract underlying datastore query patterns for external consumers.

## Policy Block

- MAY Services MAY expose public API contracts that abstract underlying datastore query patterns for external consumers.
