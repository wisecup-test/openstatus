...
1. MUST: Runtime configuration values required for external service integration MUST be retrieved from environment variables

## Policy Block

- MUST Runtime configuration values required for external service integration MUST be retrieved from environment variables
