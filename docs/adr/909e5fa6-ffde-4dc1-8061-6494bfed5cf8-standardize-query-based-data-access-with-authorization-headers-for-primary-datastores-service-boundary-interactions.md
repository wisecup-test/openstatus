...
1. MUST: All service boundary interactions with primary datastores MUST construct queries using the datastore client's query builder or parameter methods.

## Policy Block

- MUST All service boundary interactions with primary datastores MUST construct queries using the datastore client's query builder or parameter methods.
