...
1. SHOULD: Adaptive hashing algorithms should use work factors that balance security requirements against acceptable latency for authentication operations

## Policy Block

- SHOULD Adaptive hashing algorithms should use work factors that balance security requirements against acceptable latency for authentication operations
