...
1. SHOULD: Service boundary definitions SHOULD store event correlation identifiers in request context immediately upon request receipt to enable tracing across retry attempts.

## Policy Block

- SHOULD Service boundary definitions SHOULD store event correlation identifiers in request context immediately upon request receipt to enable tracing across retry attempts.
