...
1. MAY: Endpoints MAY redirect to alternative routes when required search parameters fail validation or are absent

## Policy Block

- MAY Endpoints MAY redirect to alternative routes when required search parameters fail validation or are absent
