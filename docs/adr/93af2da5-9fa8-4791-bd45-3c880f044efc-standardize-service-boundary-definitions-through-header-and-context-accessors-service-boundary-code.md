...
1. SHOULD: Service boundary code SHOULD set standard headers including User-Agent and Content-Type using header setter methods

## Policy Block

- SHOULD Service boundary code SHOULD set standard headers including User-Agent and Content-Type using header setter methods
