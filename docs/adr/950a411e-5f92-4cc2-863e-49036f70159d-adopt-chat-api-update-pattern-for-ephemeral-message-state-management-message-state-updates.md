...
1. MUST: All message state updates for ephemeral interactions must use the chat update API with channel identifier and message timestamp to modify messages in place.

## Policy Block

- MUST All message state updates for ephemeral interactions must use the chat update API with channel identifier and message timestamp to modify messages in place.
