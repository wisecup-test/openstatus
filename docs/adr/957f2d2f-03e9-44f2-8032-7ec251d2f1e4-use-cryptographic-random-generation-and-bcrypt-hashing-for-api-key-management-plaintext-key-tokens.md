...
1. MUST_NOT: Plaintext API key tokens MUST_NOT be stored in any persistent storage system after initial generation.

## Policy Block

- MUST_NOT Plaintext API key tokens MUST_NOT be stored in any persistent storage system after initial generation.
