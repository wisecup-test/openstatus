...
1. MAY: Services MAY include additional structured fields for protocol-specific data such as DNS record types, HTTP status codes, or TCP connection states

## Policy Block

- MAY Services MAY include additional structured fields for protocol-specific data such as DNS record types, HTTP status codes, or TCP connection states
