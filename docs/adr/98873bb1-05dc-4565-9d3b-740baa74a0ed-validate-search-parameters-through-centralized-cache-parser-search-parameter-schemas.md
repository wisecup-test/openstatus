...
1. SHOULD: Search parameter schemas SHOULD be defined in dedicated schema files co-located with page components

## Policy Block

- SHOULD Search parameter schemas SHOULD be defined in dedicated schema files co-located with page components
