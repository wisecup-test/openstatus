...
1. MAY: Page components MAY use parsed search parameters for query prefetching in parallel with the parsing operation

## Policy Block

- MAY Page components MAY use parsed search parameters for query prefetching in parallel with the parsing operation
