...
1. MAY: Individual tool renderers MAY implement only the rendering phases relevant to their tool's lifecycle and interaction model.

## Policy Block

- MAY Individual tool renderers MAY implement only the rendering phases relevant to their tool's lifecycle and interaction model.
