...
1. SHOULD: Custom headers SHOULD be iterable and applied to requests through a loop or batch operation to support dynamic header configuration

## Policy Block

- SHOULD Custom headers SHOULD be iterable and applied to requests through a loop or batch operation to support dynamic header configuration
