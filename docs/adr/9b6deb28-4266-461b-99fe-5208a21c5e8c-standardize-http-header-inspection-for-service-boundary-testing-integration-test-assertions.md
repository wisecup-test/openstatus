...
1. SHOULD: Integration test assertions SHOULD validate both request header propagation and response header presence

## Policy Block

- SHOULD Integration test assertions SHOULD validate both request header propagation and response header presence
