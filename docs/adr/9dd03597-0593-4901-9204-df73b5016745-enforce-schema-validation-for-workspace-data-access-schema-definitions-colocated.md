...
1. SHOULD: Schema definitions SHOULD be colocated with database table definitions to maintain consistency between persistence layer and validation layer.

## Policy Block

- SHOULD Schema definitions SHOULD be colocated with database table definitions to maintain consistency between persistence layer and validation layer.
