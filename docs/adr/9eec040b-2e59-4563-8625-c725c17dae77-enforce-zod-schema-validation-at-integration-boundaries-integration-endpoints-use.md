...
1. MAY: Integration endpoints MAY use safe parsing methods that return result types instead of throwing exceptions for validation errors

## Policy Block

- MAY Integration endpoints MAY use safe parsing methods that return result types instead of throwing exceptions for validation errors
