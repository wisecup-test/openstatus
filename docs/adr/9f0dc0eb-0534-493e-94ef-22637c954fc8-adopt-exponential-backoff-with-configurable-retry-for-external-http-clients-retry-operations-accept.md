...
1. MUST: Retry operations must accept a configurable maximum retry count parameter that governs the upper bound of retry attempts.

## Policy Block

- MUST Retry operations must accept a configurable maximum retry count parameter that governs the upper bound of retry attempts.
