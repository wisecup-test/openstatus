...
1. MUST: All HTTP client integrations that cross service boundaries MUST implement integration tests that inspect response body content

## Policy Block

- MUST All HTTP client integrations that cross service boundaries MUST implement integration tests that inspect response body content
