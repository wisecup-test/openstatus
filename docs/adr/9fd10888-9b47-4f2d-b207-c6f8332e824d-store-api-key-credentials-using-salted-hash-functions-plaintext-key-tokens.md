...
1. MUST_NOT: Plaintext API key tokens MUST_NOT be persisted in any storage layer after initial generation and presentation to the user.

## Policy Block

- MUST_NOT Plaintext API key tokens MUST_NOT be persisted in any storage layer after initial generation and presentation to the user.
