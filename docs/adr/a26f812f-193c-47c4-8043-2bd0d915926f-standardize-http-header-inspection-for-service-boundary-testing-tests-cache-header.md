...
1. MAY: Tests MAY cache header values in request context for validation across multiple service calls

## Policy Block

- MAY Tests MAY cache header values in request context for validation across multiple service calls
