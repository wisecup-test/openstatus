...
1. MAY: Client constructors MAY accept pre-configured HTTP client instances to support custom transport, timeout, and retry policies

## Policy Block

- MAY Client constructors MAY accept pre-configured HTTP client instances to support custom transport, timeout, and retry policies
