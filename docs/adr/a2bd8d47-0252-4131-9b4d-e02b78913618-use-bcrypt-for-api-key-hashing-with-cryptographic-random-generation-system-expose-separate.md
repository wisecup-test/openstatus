...
1. MAY: The system MAY expose separate public contracts for generation, hashing, verification, and usage tracking to support modular testing and deployment

## Policy Block

- MAY The system MAY expose separate public contracts for generation, hashing, verification, and usage tracking to support modular testing and deployment
