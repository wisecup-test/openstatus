...
1. MUST: HTTP client constructors MUST validate that required environment variables are present and non-empty before attempting to make requests

## Policy Block

- MUST HTTP client constructors MUST validate that required environment variables are present and non-empty before attempting to make requests
