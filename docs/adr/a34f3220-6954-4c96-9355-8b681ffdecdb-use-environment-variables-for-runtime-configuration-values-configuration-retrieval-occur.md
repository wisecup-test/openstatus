...
1. MUST: Configuration retrieval MUST occur during service initialization or client construction to fail fast if required values are missing.

## Policy Block

- MUST Configuration retrieval MUST occur during service initialization or client construction to fail fast if required values are missing.
