...
1. MUST: All internal API handlers MUST use contextual logger methods to record error conditions

## Policy Block

- MUST All internal API handlers MUST use contextual logger methods to record error conditions
