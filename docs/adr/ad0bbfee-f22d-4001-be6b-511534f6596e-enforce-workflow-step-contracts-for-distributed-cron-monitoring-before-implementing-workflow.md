...
1. MUST: Before implementing workflow contracts that depend on versioned cloud task queue libraries, database schema libraries, or email notification libraries, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all contract-related APIs exist in that version's official documentation.

## Policy Block

- MUST Before implementing workflow contracts that depend on versioned cloud task queue libraries, database schema libraries, or email notification libraries, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all contract-related APIs exist in that version's official documentation.
