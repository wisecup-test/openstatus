...
1. MUST: Cache operations MUST use string keys that identify the data type being cached

## Policy Block

- MUST Cache operations MUST use string keys that identify the data type being cached
