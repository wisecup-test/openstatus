...
1. MUST: Step contracts MUST encode temporal boundaries and state validation requirements to ensure correct progression through multi-day monitoring stages.

## Policy Block

- MUST Step contracts MUST encode temporal boundaries and state validation requirements to ensure correct progression through multi-day monitoring stages.
