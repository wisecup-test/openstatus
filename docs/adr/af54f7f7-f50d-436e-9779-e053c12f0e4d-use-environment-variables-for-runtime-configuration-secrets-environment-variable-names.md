...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention using uppercase with underscore separators

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention using uppercase with underscore separators
