...
1. MUST: HTTP clients used for external service communication MUST configure explicit timeout values to prevent unbounded blocking operations

## Policy Block

- MUST HTTP clients used for external service communication MUST configure explicit timeout values to prevent unbounded blocking operations
