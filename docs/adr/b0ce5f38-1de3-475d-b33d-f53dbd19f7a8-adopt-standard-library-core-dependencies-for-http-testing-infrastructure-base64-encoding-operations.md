...
1. MAY: Base64 encoding operations for authentication or payload encoding may use standard library encoding packages

## Policy Block

- MAY Base64 encoding operations for authentication or payload encoding may use standard library encoding packages
