...
1. SHOULD: Network operation failures in HTTP, DNS, and TCP checks SHOULD log both the error and the target resource identifier

## Policy Block

- SHOULD Network operation failures in HTTP, DNS, and TCP checks SHOULD log both the error and the target resource identifier
