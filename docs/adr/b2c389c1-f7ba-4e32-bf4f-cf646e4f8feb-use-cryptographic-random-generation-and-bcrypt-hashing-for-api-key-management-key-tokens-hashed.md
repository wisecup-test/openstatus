...
1. MUST: API key tokens MUST be hashed using bcrypt with a minimum cost factor of 10 before persistence.

## Policy Block

- MUST API key tokens MUST be hashed using bcrypt with a minimum cost factor of 10 before persistence.
