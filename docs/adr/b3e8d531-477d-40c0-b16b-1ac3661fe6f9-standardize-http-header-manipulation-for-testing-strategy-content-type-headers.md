...
1. MUST: Content-Type headers MUST be validated on both request and response objects to ensure correct content negotiation

## Policy Block

- MUST Content-Type headers MUST be validated on both request and response objects to ensure correct content negotiation
