...
1. MUST: Environment variable names for secrets MUST follow a consistent naming convention that clearly identifies the purpose and target service of each credential

## Policy Block

- MUST Environment variable names for secrets MUST follow a consistent naming convention that clearly identifies the purpose and target service of each credential
