...
1. MAY: Handlers may delegate complex business logic to separate asynchronous functions that accept validated state and return presentation-ready results

## Policy Block

- MAY Handlers may delegate complex business logic to separate asynchronous functions that accept validated state and return presentation-ready results
