...
1. SHOULD: Validation logic SHOULD be colocated with the page component's search parameter type definitions to maintain consistency between expected and validated schemas

## Policy Block

- SHOULD Validation logic SHOULD be colocated with the page component's search parameter type definitions to maintain consistency between expected and validated schemas
