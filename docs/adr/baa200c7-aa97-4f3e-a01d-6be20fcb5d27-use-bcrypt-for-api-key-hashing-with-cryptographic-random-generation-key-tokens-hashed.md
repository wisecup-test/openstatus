...
1. MUST: API key tokens MUST be hashed using an adaptive key derivation function with a work factor of at least 10 before storage

## Policy Block

- MUST API key tokens MUST be hashed using an adaptive key derivation function with a work factor of at least 10 before storage
