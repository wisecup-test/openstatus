...
1. MUST: Tool rendering logic MUST be registered in a centralized registry that maps tool names to renderer implementations

## Policy Block

- MUST Tool rendering logic MUST be registered in a centralized registry that maps tool names to renderer implementations
