...
1. SHOULD: External client implementations SHOULD encapsulate HTTP client instances as struct fields to enable dependency injection and testing

## Policy Block

- SHOULD External client implementations SHOULD encapsulate HTTP client instances as struct fields to enable dependency injection and testing
