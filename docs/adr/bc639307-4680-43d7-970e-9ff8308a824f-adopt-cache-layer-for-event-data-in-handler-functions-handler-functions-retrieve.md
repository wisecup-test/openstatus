# Adopt Cache Layer for Event Data in Handler Functions: Handler Functions Retrieve
...
1. MUST: Handler functions MUST retrieve event data from the cache layer using Get operations before processing health check requests

## Policy Block

- MUST Handler functions MUST retrieve event data from the cache layer using Get operations before processing health check requests
