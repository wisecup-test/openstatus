...
1. MUST: Workflow step coordination MUST use explicit step identifiers and state machines to manage multi-day execution lifecycles

## Policy Block

- MUST Workflow step coordination MUST use explicit step identifiers and state machines to manage multi-day execution lifecycles
