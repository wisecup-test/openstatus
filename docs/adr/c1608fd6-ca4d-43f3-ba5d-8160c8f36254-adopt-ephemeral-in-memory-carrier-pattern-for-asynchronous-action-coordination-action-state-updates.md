...
1. SHOULD: Action state updates SHALL support replace operations that preserve action identity while updating payload content

## Policy Block

- SHOULD Action state updates SHALL support replace operations that preserve action identity while updating payload content
