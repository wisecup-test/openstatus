...
1. SHOULD: Schema definitions SHOULD be colocated with integration endpoint handlers to maintain visibility of validation contracts

## Policy Block

- SHOULD Schema definitions SHOULD be colocated with integration endpoint handlers to maintain visibility of validation contracts
