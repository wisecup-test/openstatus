...
1. MUST: Handler functions that coordinate external client operations MUST log errors with context propagated from the request lifecycle

## Policy Block

- MUST Handler functions that coordinate external client operations MUST log errors with context propagated from the request lifecycle
