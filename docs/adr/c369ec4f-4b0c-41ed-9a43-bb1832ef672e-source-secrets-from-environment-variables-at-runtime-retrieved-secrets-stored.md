...
1. MUST: Retrieved secrets MUST be stored in memory only for the duration of their use and MUST NOT be logged, printed to standard output, or persisted to disk

## Policy Block

- MUST Retrieved secrets MUST be stored in memory only for the duration of their use and MUST NOT be logged, printed to standard output, or persisted to disk
