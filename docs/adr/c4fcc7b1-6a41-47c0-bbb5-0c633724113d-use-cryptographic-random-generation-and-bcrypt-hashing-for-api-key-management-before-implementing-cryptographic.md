...
1. MUST: Before implementing cryptographic operations with any versioned library, the exact resolved version MUST be determined from the project's lock or resolution artifact

## Policy Block

- MUST Before implementing cryptographic operations with any versioned library, the exact resolved version MUST be determined from the project's lock or resolution artifact
