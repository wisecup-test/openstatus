...
1. SHOULD: HTTP handler functions SHOULD attach request identifiers and event metadata to the context before passing to downstream operations

## Policy Block

- SHOULD HTTP handler functions SHOULD attach request identifiers and event metadata to the context before passing to downstream operations
