...
1. SHOULD: The cost factor for adaptive hashing SHOULD be configured to balance security requirements with acceptable authentication latency.

## Policy Block

- SHOULD The cost factor for adaptive hashing SHOULD be configured to balance security requirements with acceptable authentication latency.
