...
1. MUST: Response body content required for assertion evaluation must be read into memory buffers before processing to enable multiple reads and consistent error handling

## Policy Block

- MUST Response body content required for assertion evaluation must be read into memory buffers before processing to enable multiple reads and consistent error handling
