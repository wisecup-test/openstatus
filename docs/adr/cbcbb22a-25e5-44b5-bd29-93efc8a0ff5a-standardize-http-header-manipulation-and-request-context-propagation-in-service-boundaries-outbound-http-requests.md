...
1. MUST: Outbound HTTP requests to external services MUST set a User-Agent header identifying the service and version

## Policy Block

- MUST Outbound HTTP requests to external services MUST set a User-Agent header identifying the service and version
