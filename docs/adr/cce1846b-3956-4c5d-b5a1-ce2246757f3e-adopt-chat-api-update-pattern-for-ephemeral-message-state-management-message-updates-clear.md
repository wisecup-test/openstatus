...
1. MUST: Message updates must clear interactive blocks by setting the blocks array to empty when transitioning to terminal states such as error, cancellation, or expiration.

## Policy Block

- MUST Message updates must clear interactive blocks by setting the blocks array to empty when transitioning to terminal states such as error, cancellation, or expiration.
