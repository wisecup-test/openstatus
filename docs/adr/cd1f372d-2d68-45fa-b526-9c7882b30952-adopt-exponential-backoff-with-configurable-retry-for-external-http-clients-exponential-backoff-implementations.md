...
1. SHOULD: Exponential backoff implementations should use context-aware retry functions that respect cancellation signals and deadline propagation.

## Policy Block

- SHOULD Exponential backoff implementations should use context-aware retry functions that respect cancellation signals and deadline propagation.
