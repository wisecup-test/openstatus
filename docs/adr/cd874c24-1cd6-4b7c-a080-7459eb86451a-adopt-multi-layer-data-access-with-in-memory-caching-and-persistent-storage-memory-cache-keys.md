...
1. SHOULD: In-memory cache keys should encode entity type, identifier, and scope to enable efficient invalidation and prevent key collisions across namespaces

## Policy Block

- SHOULD In-memory cache keys should encode entity type, identifier, and scope to enable efficient invalidation and prevent key collisions across namespaces
