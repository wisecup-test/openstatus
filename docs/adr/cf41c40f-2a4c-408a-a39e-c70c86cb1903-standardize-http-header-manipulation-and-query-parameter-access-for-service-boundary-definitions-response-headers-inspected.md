...
1. SHOULD: Response headers SHOULD be inspected to extract metadata required for downstream processing or observability

## Policy Block

- SHOULD Response headers SHOULD be inspected to extract metadata required for downstream processing or observability
