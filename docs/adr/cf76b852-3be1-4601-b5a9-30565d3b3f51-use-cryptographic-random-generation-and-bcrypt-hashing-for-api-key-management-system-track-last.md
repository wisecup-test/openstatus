...
1. SHOULD: The system SHOULD track last-used timestamps for API keys to support usage auditing and key rotation policies.

## Policy Block

- SHOULD The system SHOULD track last-used timestamps for API keys to support usage auditing and key rotation policies.
