...
1. MUST: Response validation contracts MUST expose Body, Header, and status code accessors for assertion evaluation

## Policy Block

- MUST Response validation contracts MUST expose Body, Header, and status code accessors for assertion evaluation
