...
1. MUST: HTTP client construction MUST accept timeout configuration as an explicit parameter and apply it to the client instance.

## Policy Block

- MUST HTTP client construction MUST accept timeout configuration as an explicit parameter and apply it to the client instance.
