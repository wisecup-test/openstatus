...
1. SHOULD: Request and response body data structures used in integration testing should be serializable to JSON for logging, event forwarding, and assertion evaluation

## Policy Block

- SHOULD Request and response body data structures used in integration testing should be serializable to JSON for logging, event forwarding, and assertion evaluation
