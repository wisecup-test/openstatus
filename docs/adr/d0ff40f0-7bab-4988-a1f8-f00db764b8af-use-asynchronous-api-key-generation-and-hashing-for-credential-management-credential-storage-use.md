...
1. MUST: Credential storage MUST use bcrypt hashing with a minimum cost factor of 10

## Policy Block

- MUST Credential storage MUST use bcrypt hashing with a minimum cost factor of 10
