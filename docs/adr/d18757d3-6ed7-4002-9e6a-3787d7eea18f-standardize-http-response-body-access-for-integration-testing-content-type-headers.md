...
1. MUST: Content-Type headers shall be validated via Header.Get before processing request or response bodies

## Policy Block

- MUST Content-Type headers shall be validated via Header.Get before processing request or response bodies
