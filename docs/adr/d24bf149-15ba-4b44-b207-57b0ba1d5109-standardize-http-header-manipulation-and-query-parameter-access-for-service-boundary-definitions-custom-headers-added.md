...
1. MAY: Custom headers MAY be added to requests for tracing, correlation, or feature flag propagation

## Policy Block

- MAY Custom headers MAY be added to requests for tracing, correlation, or feature flag propagation
