...
1. MUST: The consumer MUST discover the project's dependency lock artifact and resolve the exact installed versions of cryptographic and hashing libraries before implementing credential operations.

## Policy Block

- MUST The consumer MUST discover the project's dependency lock artifact and resolve the exact installed versions of cryptographic and hashing libraries before implementing credential operations.
