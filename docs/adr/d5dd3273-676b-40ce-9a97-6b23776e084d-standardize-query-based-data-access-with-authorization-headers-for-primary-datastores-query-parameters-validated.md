...
1. SHOULD: Query parameters SHOULD be validated using schema validation before being passed to datastore clients.

## Policy Block

- SHOULD Query parameters SHOULD be validated using schema validation before being passed to datastore clients.
