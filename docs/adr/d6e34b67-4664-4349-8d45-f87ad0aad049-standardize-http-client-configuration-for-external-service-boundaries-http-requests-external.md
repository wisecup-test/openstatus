...
1. MUST: HTTP requests to external services MUST set User-Agent headers to identify the calling service

## Policy Block

- MUST HTTP requests to external services MUST set User-Agent headers to identify the calling service
