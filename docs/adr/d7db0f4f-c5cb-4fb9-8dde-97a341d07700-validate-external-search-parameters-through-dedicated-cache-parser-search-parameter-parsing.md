...
1. MUST: Search parameter parsing MUST occur before any data prefetching, query construction, or routing decision that depends on parameter values

## Policy Block

- MUST Search parameter parsing MUST occur before any data prefetching, query construction, or routing decision that depends on parameter values
