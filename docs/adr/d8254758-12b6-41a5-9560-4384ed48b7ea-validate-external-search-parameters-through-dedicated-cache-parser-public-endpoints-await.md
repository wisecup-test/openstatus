...
1. MUST: Public API endpoints MUST await the resolution of Promise-wrapped search parameters before passing them to the validation parser

## Policy Block

- MUST Public API endpoints MUST await the resolution of Promise-wrapped search parameters before passing them to the validation parser
