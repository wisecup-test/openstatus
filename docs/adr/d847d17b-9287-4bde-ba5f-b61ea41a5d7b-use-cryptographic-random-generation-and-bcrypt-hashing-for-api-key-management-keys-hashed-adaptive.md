...
1. MUST: API keys MUST be hashed using an adaptive hashing algorithm with a minimum work factor of 10 before storage.

## Policy Block

- MUST API keys MUST be hashed using an adaptive hashing algorithm with a minimum work factor of 10 before storage.
