...
1. MUST: Context value storage and retrieval at service boundaries MUST use framework context accessor methods with string keys

## Policy Block

- MUST Context value storage and retrieval at service boundaries MUST use framework context accessor methods with string keys
