...
1. SHOULD: Step contracts SHOULD include explicit paused-state handling to support workflow suspension without losing monitoring context or violating rate limits.

## Policy Block

- SHOULD Step contracts SHOULD include explicit paused-state handling to support workflow suspension without losing monitoring context or violating rate limits.
