...
1. MUST: API key generation MUST use cryptographically secure random byte generation with sufficient entropy to prevent prediction or collision attacks.

## Policy Block

- MUST API key generation MUST use cryptographically secure random byte generation with sufficient entropy to prevent prediction or collision attacks.
