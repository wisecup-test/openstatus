...
1. SHOULD: Cache keys SHOULD follow hierarchical naming conventions that encode entity type and identifier for efficient invalidation

## Policy Block

- SHOULD Cache keys SHOULD follow hierarchical naming conventions that encode entity type and identifier for efficient invalidation
