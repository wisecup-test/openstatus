...
1. SHOULD: Logging implementations should use structured logging libraries that support leveled output and machine-readable formats

## Policy Block

- SHOULD Logging implementations should use structured logging libraries that support leveled output and machine-readable formats
