...
1. MUST: All credential hashing operations MUST be implemented as asynchronous functions to prevent blocking the event loop

## Policy Block

- MUST All credential hashing operations MUST be implemented as asynchronous functions to prevent blocking the event loop
