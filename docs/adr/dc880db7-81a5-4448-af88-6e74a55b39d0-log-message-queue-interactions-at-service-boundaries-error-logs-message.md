...
1. MUST: Error logs at message queue boundaries MUST include the error object, the operation being attempted, and any identifiers necessary to trace the message through the system.

## Policy Block

- MUST Error logs at message queue boundaries MUST include the error object, the operation being attempted, and any identifiers necessary to trace the message through the system.
