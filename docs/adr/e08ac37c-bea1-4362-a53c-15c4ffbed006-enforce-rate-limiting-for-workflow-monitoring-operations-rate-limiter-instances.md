...
1. MUST: Rate limiter instances MUST be initialized with explicit tokensPerInterval and interval parameters that align with the documented quota limits of the target external service.

## Policy Block

- MUST Rate limiter instances MUST be initialized with explicit tokensPerInterval and interval parameters that align with the documented quota limits of the target external service.
