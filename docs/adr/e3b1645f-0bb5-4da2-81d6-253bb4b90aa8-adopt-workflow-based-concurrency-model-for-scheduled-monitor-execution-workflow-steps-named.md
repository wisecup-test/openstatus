...
1. SHOULD: Workflow steps SHOULD be named to reflect their temporal or lifecycle position in the execution sequence

## Policy Block

- SHOULD Workflow steps SHOULD be named to reflect their temporal or lifecycle position in the execution sequence
