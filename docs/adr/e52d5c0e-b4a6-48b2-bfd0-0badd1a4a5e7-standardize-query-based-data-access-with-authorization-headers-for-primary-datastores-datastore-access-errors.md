...
1. MUST: Datastore access errors MUST be logged with contextual information using the service's logging infrastructure.

## Policy Block

- MUST Datastore access errors MUST be logged with contextual information using the service's logging infrastructure.
