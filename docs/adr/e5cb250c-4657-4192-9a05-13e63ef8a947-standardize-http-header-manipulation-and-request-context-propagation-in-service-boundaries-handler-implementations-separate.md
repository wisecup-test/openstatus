...
1. SHOULD: Handler implementations SHOULD separate protocol-specific header manipulation from business logic by using the cache-layer abstraction for context access

## Policy Block

- SHOULD Handler implementations SHOULD separate protocol-specific header manipulation from business logic by using the cache-layer abstraction for context access
