...
1. SHOULD: Logging statements SHOULD include relevant operational context such as protocol type, region identifier, retry attempt number, and timing information

## Policy Block

- SHOULD Logging statements SHOULD include relevant operational context such as protocol type, region identifier, retry attempt number, and timing information
