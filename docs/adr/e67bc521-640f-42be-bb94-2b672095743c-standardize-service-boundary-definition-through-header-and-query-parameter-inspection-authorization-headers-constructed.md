...
1. MUST: Authorization headers MUST be constructed using bearer token formatting when communicating with external datastores

## Policy Block

- MUST Authorization headers MUST be constructed using bearer token formatting when communicating with external datastores
