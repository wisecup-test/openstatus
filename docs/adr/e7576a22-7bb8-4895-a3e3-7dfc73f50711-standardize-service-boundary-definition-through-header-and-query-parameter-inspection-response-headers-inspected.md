...
1. SHOULD: Response headers SHOULD be inspected by key to extract metadata required for downstream processing

## Policy Block

- SHOULD Response headers SHOULD be inspected by key to extract metadata required for downstream processing
