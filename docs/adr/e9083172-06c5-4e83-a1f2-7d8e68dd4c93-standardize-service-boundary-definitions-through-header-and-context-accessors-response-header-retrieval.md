...
1. MUST: Response header retrieval MUST use designated getter methods that accept header key parameters

## Policy Block

- MUST Response header retrieval MUST use designated getter methods that accept header key parameters
