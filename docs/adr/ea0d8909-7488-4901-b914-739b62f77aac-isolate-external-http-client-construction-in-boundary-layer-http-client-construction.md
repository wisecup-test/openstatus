...
1. SHOULD: HTTP client construction SHOULD apply consistent transport-level configuration including TLS settings and connection pooling parameters.

## Policy Block

- SHOULD HTTP client construction SHOULD apply consistent transport-level configuration including TLS settings and connection pooling parameters.
