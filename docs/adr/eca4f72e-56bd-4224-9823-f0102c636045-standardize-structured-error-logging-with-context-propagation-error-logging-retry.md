# Standardize Structured Error Logging with Context Propagation: Error Logging Retry
...
1. SHOULD: Error logging in retry loops SHOULD capture the attempt number and backoff state to distinguish transient from persistent failures

## Policy Block

- SHOULD Error logging in retry loops SHOULD capture the attempt number and backoff state to distinguish transient from persistent failures
