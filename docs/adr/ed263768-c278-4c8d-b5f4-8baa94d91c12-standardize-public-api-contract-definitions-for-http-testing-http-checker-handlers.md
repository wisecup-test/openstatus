...
1. MUST: All HTTP checker handlers MUST define public contract types for request data structures that include Body, Header, Timeout, and assertion fields

## Policy Block

- MUST All HTTP checker handlers MUST define public contract types for request data structures that include Body, Header, Timeout, and assertion fields
