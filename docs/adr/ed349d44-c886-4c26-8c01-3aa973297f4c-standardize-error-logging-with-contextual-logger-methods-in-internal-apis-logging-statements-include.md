...
1. SHOULD: Logging statements SHOULD include structured context fields derived from the request context

## Policy Block

- SHOULD Logging statements SHOULD include structured context fields derived from the request context
