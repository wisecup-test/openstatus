...
1. MUST: Action payloads SHALL be validated against schemas before storage and after retrieval to ensure type safety across the temporal boundary

## Policy Block

- MUST Action payloads SHALL be validated against schemas before storage and after retrieval to ensure type safety across the temporal boundary
