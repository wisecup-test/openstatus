...
1. SHOULD: Logging statements SHOULD include a consistent prefix or namespace identifier to distinguish message queue boundary logs from other application logs.

## Policy Block

- SHOULD Logging statements SHOULD include a consistent prefix or namespace identifier to distinguish message queue boundary logs from other application logs.
