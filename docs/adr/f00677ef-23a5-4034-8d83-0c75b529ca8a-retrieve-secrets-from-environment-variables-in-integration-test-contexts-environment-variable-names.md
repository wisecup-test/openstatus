...
1. MUST: Environment variable names for secrets SHALL use uppercase naming with underscore separators and include a semantic suffix indicating the credential type or target service

## Policy Block

- MUST Environment variable names for secrets SHALL use uppercase naming with underscore separators and include a semantic suffix indicating the credential type or target service
