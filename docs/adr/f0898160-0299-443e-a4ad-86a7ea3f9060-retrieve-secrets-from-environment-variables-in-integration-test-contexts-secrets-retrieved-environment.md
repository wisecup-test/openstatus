...
1. MUST: Secrets retrieved from environment variables SHALL be consumed immediately within the same initialization context and SHALL NOT be stored in global variables or persistent state

## Policy Block

- MUST Secrets retrieved from environment variables SHALL be consumed immediately within the same initialization context and SHALL NOT be stored in global variables or persistent state
