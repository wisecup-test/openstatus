...
1. SHOULD: Validation failures on deserialized message payloads SHOULD log the validation error details and the raw or sanitized payload to aid debugging.

## Policy Block

- SHOULD Validation failures on deserialized message payloads SHOULD log the validation error details and the raw or sanitized payload to aid debugging.
