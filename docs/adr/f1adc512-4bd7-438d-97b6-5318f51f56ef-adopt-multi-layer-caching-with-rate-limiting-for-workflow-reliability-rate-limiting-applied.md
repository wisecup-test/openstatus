...
1. MUST: Rate limiting MUST be applied to workflow operations with token bucket configuration specifying tokens per interval and interval duration

## Policy Block

- MUST Rate limiting MUST be applied to workflow operations with token bucket configuration specifying tokens per interval and interval duration
