...
1. MUST: Error logging must extract error messages through error interface methods rather than string formatting of error objects

## Policy Block

- MUST Error logging must extract error messages through error interface methods rather than string formatting of error objects
