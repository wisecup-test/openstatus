...
1. MUST: Tool renderers MUST be registered in a centralized registry that enables lookup by tool name string identifier.

## Policy Block

- MUST Tool renderers MUST be registered in a centralized registry that enables lookup by tool name string identifier.
