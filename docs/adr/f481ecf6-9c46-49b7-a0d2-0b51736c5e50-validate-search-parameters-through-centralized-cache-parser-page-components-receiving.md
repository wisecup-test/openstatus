...
1. MUST: Page components receiving search parameters as promises MUST await the promise before passing to the validation parser

## Policy Block

- MUST Page components receiving search parameters as promises MUST await the promise before passing to the validation parser
