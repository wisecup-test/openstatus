...
1. MUST: API keys MUST be hashed using adaptive cost factor algorithms before storage in credential repositories.

## Policy Block

- MUST API keys MUST be hashed using adaptive cost factor algorithms before storage in credential repositories.
