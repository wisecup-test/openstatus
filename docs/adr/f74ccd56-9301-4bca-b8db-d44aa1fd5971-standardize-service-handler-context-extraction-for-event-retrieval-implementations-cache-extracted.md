...
1. MAY: Implementations MAY cache extracted event data in the request context using the framework's context storage mechanism

## Policy Block

- MAY Implementations MAY cache extracted event data in the request context using the framework's context storage mechanism
