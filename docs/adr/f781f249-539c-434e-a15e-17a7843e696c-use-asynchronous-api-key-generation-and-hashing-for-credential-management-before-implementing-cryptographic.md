...
1. MUST: Before implementing cryptographic operations with any versioned library, the consumer MUST discover the project's dependency lock artifact and resolve the exact installed version

## Policy Block

- MUST Before implementing cryptographic operations with any versioned library, the consumer MUST discover the project's dependency lock artifact and resolve the exact installed version
