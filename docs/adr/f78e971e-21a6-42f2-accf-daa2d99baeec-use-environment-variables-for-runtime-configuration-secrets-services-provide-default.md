...
1. MAY: Services MAY provide default values for non-sensitive configuration when environment variables are absent

## Policy Block

- MAY Services MAY provide default values for non-sensitive configuration when environment variables are absent
