...
1. SHOULD: HTTP header manipulation for integration testing should preserve Content-Type detection and allow custom header injection for user agent identification and authentication

## Policy Block

- SHOULD HTTP header manipulation for integration testing should preserve Content-Type detection and allow custom header injection for user agent identification and authentication
