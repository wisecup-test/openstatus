...
1. SHOULD: Handlers SHOULD propagate the extracted context to logging operations for observability correlation

## Policy Block

- SHOULD Handlers SHOULD propagate the extracted context to logging operations for observability correlation
