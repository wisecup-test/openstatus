...
1. MUST: Consumers shall discover the exact resolved version of all cryptographic and hashing libraries from the project's dependency lock artifact before implementing credential operations

## Policy Block

- MUST Consumers shall discover the exact resolved version of all cryptographic and hashing libraries from the project's dependency lock artifact before implementing credential operations
