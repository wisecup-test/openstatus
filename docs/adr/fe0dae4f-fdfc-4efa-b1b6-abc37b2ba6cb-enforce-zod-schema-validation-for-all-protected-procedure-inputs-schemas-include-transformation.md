...
1. MAY: Schemas MAY include transformation rules such as coercion, normalization, or default values when the transformation preserves semantic meaning

## Policy Block

- MAY Schemas MAY include transformation rules such as coercion, normalization, or default values when the transformation preserves semantic meaning
