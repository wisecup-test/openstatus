...
1. MUST: HTTP client implementations MUST set User-Agent headers to identify the calling service

## Policy Block

- MUST HTTP client implementations MUST set User-Agent headers to identify the calling service
