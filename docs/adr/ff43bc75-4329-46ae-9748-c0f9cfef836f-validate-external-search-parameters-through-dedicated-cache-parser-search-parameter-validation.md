...
1. SHOULD: Search parameter validation logic SHOULD be centralized in a single cache parser instance to ensure consistent validation rules across all public endpoints

## Policy Block

- SHOULD Search parameter validation logic SHOULD be centralized in a single cache parser instance to ensure consistent validation rules across all public endpoints
