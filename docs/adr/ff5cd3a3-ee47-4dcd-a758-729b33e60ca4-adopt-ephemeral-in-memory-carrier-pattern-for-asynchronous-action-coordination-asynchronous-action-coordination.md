...
1. MUST: All asynchronous action coordination SHALL use a carrier abstraction that separates storage concerns from business logic

## Policy Block

- MUST All asynchronous action coordination SHALL use a carrier abstraction that separates storage concerns from business logic
